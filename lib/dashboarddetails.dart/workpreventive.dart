// work_preventive_details_page.dart
import 'package:flutter/material.dart';
import 'package:loginuicolors/model/model.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class WorkPreventiveDetailsPage extends StatefulWidget {
  @override
  _WorkPreventiveDetailsPageState createState() =>
      _WorkPreventiveDetailsPageState();
}

class _WorkPreventiveDetailsPageState extends State<WorkPreventiveDetailsPage> {
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        ...
                        //     context,
                        //     MaterialPageRoute(
                        //       builder: (context) => WorkPreventiveDetailPage(workorder: workorder),
                        //     ),
                        //   );
                      },
                    ),
