...
//
//     final workers = workersFromJson(jsonString);
...
class DashboardDetails {
    ...
    factory DashboardDetails.fromJson(Map<String, dynamic> json) => DashboardDetails(
        openPreventive: json["open_preventive"],
        assignedPreventive: json["assigned_preventive"],
        completedPreventive: json["completed_preventive"],
        openCorrective: json["open_corrective"],
        assignedCorrective: json["assigned_corrective"],
        verifiedCorrective: json["verified_corrective"],
        completedCorrective: json["completed_corrective"],
        recentWorkordersPreventive: List<RecentWorkordersPreventive>.from(json["recent_workorders_preventive"].map((x) => RecentWorkordersPreventive.fromJson(x))),
        recentWorkordersCorrective: List<RecentWorkordersCorrective>.from(json["recent_workorders_corrective"].map((x) => RecentWorkordersCorrective.fromJson(x))),
        workordersAssigned: List<RecentWorkordersPreventive>.from(json["workorders_assigned"].map((x) => RecentWorkordersPreventive.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "recent_workorders_preventive": List<dynamic>.from(recentWorkordersPreventive.map((x) => x.toJson())),
        "recent_workorders_corrective": List<dynamic>.from(recentWorkordersCorrective.map((x) => x.toJson())),
        "workorders_assigned": List<dynamic>.from(workordersAssigned.map((x) => x.toJson())),
    };
}
...
class RecentWorkordersCorrective {
    ...
    factory RecentWorkordersCorrective.fromJson(Map<String, dynamic> json) => RecentWorkordersCorrective(
        id: json["id"],
        woName: json["wo_name"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "folder_id": folderId,
        "billable": billable,
        "schedule_first_date": "${scheduleFirstDate.year.toString().padLeft(4, '0')}-${scheduleFirstDate.month.toString().padLeft(2, '0')}-${scheduleFirstDate.day.toString().padLeft(2, '0')}",
        "crew_size": crewSize,
...
final priorityValues = EnumValues({
    "P1: Urgent": Priority.P1_URGENT,
    "P2: Normal": Priority.P2_NORMAL
});
...
enum RecentWorkordersCorrectiveStatus {
    OPEN
}

final recentWorkordersCorrectiveStatusValues = EnumValues({
    "OPEN": RecentWorkordersCorrectiveStatus.OPEN
});
...
class RecentWorkordersPreventive {
    ...
    factory RecentWorkordersPreventive.fromJson(Map<String, dynamic> json) => RecentWorkordersPreventive(
        id: json["id"],
        ...
        actualStartDate: json["actual_start_date"] == null ? null : DateTime.parse(json["actual_start_date"]),
        actualFinishDate: json["actual_finish_date"] == null ? null : DateTime.parse(json["actual_finish_date"]),
        closedDate: json["closed_date"] == null ? null : DateTime.parse(json["closed_date"]),
        ...
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        template: json["template"] == null ? null : RecentWorkordersCorrective.fromJson(json["template"]),
    );
...
enum RecentWorkordersPreventiveStatus {
    CLOSED,
    SCHEDULED
}
